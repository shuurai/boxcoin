# Support for Output Descriptors in Boxcoin Core

Since Boxcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Boxcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Boxcoin Core wallets, a convenience function `combo` is
