# Support for Output Descriptors in Lifecoin Core

Since Lifecoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `wlc1...` for mainnet or `twlc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Lifecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Lifecoin Core wallets, a convenience function `combo` is
