...
{
    const char* pszTimestamp = "DF meets and loves GYX since 09/09/2018 @ Sydney"; // NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56
...
public:
    CMainParams() {
        ...
        // TODO add my own later
        // vSeeds.emplace_back("seed-a.boxcoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.boxcointools.com");
        // vSeeds.emplace_back("dnsseed.boxcoinpool.org");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25); // 48
        ...
        checkpointData = {
            {
                {       0, uint256S("0x5fc6259da4a120a30e14fe535dcbe427cc947feb516d4d786e926ef6cf6a1cb8")}.
                {     746, uint256S("0x0a3600dc8998f09a8e1df60705877b3a0eb95776c4622bd94aea1f0527ca49b1")},
                {    3268, uint256S("0x52d7d62d4bf82aea25051b763132dce5072f7de8592191e7a2ee43995a27798a")},
                {  4560, uint256S("0x8d87150b01f5e44ecf058458c56f11c4d9c13f92be7fe449fba290c6b6cfdff6")},
                { 10130, uint256S("0xfffc0948e783ee1ccf60a52564e57fdbb922c1477a3ed4bbaee30cdac36e2aac")},
                { 13395, uint256S("0xf4ad7a6b2e56cb6cd85fae56a13ab847591c47ece43802ad4e521f9ad91b29a7")}
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.boxcointools.com");
        // vSeeds.emplace_back("seed-b.boxcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        std::printf("test genesis[%s]\n", consensus.hashGenesisBlock.ToString().c_str());
        std::printf("test root[%s]\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(consensus.hashGenesisBlock == uint256S("ac9d00b67b97a54a3888cacdcd3f09c5c0d69293d06aede001412fb23e360cf7"));
        assert(genesis.hashMerkleRoot == uint256S("0f711d071a2a5110596cc395100d3338eb4554b20b374308d3bfd091289fcb45"));
