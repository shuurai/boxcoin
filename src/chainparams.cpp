...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.lifecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.lifecointools.com");
        vSeeds.emplace_back("dnsseed.lifecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.lifecointools.com");
        vSeeds.emplace_back("seed-b.lifecoin.loshan.co.uk");
