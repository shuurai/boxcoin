        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated lifecoin to."},
            ...
            + "If you are running the lifecoin core wallet, you can get a new address to send the newly generated lifecoin to with:\n"
