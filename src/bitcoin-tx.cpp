...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " lifecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  lifecoin-tx [options] <hex-tx> [commands]  Update hex-encoded lifecoin transaction\n" +
            "or:     lifecoin-tx [options] -create [commands]   Create hex-encoded lifecoin transaction\n" +
            "\n";
