...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " boxcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  boxcoin-tx [options] <hex-tx> [commands]  Update hex-encoded boxcoin transaction\n" +
            "or:     boxcoin-tx [options] -create [commands]   Create hex-encoded boxcoin transaction\n" +
            "\n";
