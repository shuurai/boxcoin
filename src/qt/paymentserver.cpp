...
const char* BIP71_MIMETYPE_PAYMENT = "application/lifecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/lifecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/lifecoin-paymentrequest";
#endif
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start lifecoin: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("lifecoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'lifecoin://' is not a valid URI. Use 'lifecoin:' instead."),
    ...
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Lifecoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
