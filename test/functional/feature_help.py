...
"""Verify that starting lifecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start lifecoin with -h for help text")
        ...
        self.log.info("Start lifecoin with -version for version information")
        ...
        self.log.info("Start lifecoind with -fakearg to make sure it does not start")
