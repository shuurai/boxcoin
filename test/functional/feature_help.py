...
"""Verify that starting boxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start boxcoin with -h for help text")
        ...
        self.log.info("Start boxcoin with -version for version information")
        ...
        self.log.info("Start boxcoind with -fakearg to make sure it does not start")
